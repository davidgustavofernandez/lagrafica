...
class Token {	
	 ...
	 */
	public function setChars($strLower = true, $strUpper = true, $strNumbers = true, $strSpecial = false, $strCustom = '')
	{
		$this->_strLower 	= $strLower;
		$this->_strUpper 	= $strUpper;
		$this->_strNumbers 	= $strNumbers;
		$this->_strSpecial 	= $strSpecial;
		$this->_strCustom 	= $strCustom;
	}
	...
	public function getToken()
	{
		...
		$this->_aplicaStr = ($this->_strCustom) 		? $this->_aplicaStr .= $this->_strCustom 			: $this->_aplicaStr;
