        ...
        if (isset($this->_typeArray['TYPE']) && isset($this->_typeArray['NAME']) && isset($this->_typeArray['ID']) && isset($this->_typeArray['VALUE'])) {
            ...
            switch ($this->_typeArray['TYPE']) {
                ...
                case 'file':
                    ...
                    if (!empty($value)) {
                        if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'thumb/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'small/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'big/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'media/' . $value)) {
                            ...
                            if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'thumb/' . $value)) {
                                $in_path = 'thumb/';
                            } else if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'small/' . $value)) {
                                $in_path = 'small/';
                            } elseif (file_exists($this->_typeArray['PATHPHYSICAL'] . 'big/' . $value)) {
                                $in_path = 'big/';
                            } elseif (file_exists($this->_typeArray['PATHPHYSICAL'] . 'media/' . $value)) {
                                $in_path = 'media/';
                            }
                            if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'media/' . $value)) {
                                $in_path_big = 'media/';
                            } else if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'big/' . $value)) {
                                $in_path_big = 'big/';
                            } elseif (file_exists($this->_typeArray['PATHPHYSICAL'] . 'small/' . $value)) {
                                $in_path_big = 'small/';
                            } elseif (file_exists($this->_typeArray['PATHPHYSICAL'] . 'thumb/' . $value)) {
                                $in_path_big = 'thumb/';
                            }
                        ...
                        for ($i = 0; $i < $lengDatos; $i++) //loop de los campos
                        {
                            ...
                            if ($retorno[$i]->$key_foraneo == $value) {
                                if (!empty($retorno[$i]->id_setting_country_language)) {
                                    $combo .= "<option value='" . $retorno[$i]->$key_foraneo . "' selected=selected>" . $name . $last_name . " - " . $retorno[$i]->id_setting_country_language . "</option>" . "\n";
                                } else {
                                    $combo .= "<option value='" . $retorno[$i]->$key_foraneo . "' selected=selected>" . $name . $last_name . "</option>" . "\n";
                                }
                            } else {
                                if (!empty($retorno[$i]->id_setting_country_language)) {
                                    $combo .= "<option value='" . $retorno[$i]->$key_foraneo . "' >" . $name . $last_name . " - " . $retorno[$i]->id_setting_country_language . "</option>" . "\n";
                                } else {
                                    $combo .= "<option value='" . $retorno[$i]->$key_foraneo . "' >" . $name . $last_name . "</option>" . "\n";
                                }
                            }
                        }
                        $combo .= "</select>";
                ...
                case 'date':
                    ...
                    $rand = rand(5, 5);
                    $calendario = '';
                    $calendario .= '<input type="text" name="' . $this->_typeArray['NAME'] . '" id="' . $this->_typeArray['ID'] . '" value="' . $value . '" class="form-control date" />' . "\n";
                    $calendario .= '';
                ...
                case 'datetime':
                    ...
                    $rand = rand(5, 5);
                    $calendario = '';
                    $calendario .= '<input type="text" name="' . $this->_typeArray['NAME'] . '" id="' . $this->_typeArray['ID'] . '" value="' . $value . '" class="form-control datetime" />' . "\n";
                    $calendario .= '';
                    $this->_result = $calendario;
                    break;
                case 'timestamp':
        ...
        if (isset($this->_typeArray['TYPE']) && isset($this->_typeArray['NAME']) && isset($this->_typeArray['ID']) && isset($this->_typeArray['VALUE'])) {
            ...
            switch ($this->_typeArray['TYPE']) {
                ...
                case 'char':
                    ...
                    break;
                case 'checkbox':
                    $this->_result = '' . $value == 0 ? '<font style="color:#f64e60;">NO</font>' : '<font style="color:#1cc88a;">SI</font>' . '';
                    break;
                case 'radio':
                    $this->_result = '' . $value . '';
                    break;
                    ...
                    if (is_array($retorno)) {
                        ...
                        for ($i = 0; $i < $lengDatos; $i++) //loop de los campos
                        {
                            ...
                            if (is_object($retorno[$i])) {
                                ...
                                if ($retorno[$i]->$key_foraneo == $value) {
                                    // $combo .= '<font style="color:#4e73df;">'. $key_foraneo . ' - ' . $name . $last_name.'</font><br>';
                                    $combo .= '<font style="color:#4e73df;">' . $value . ' - ' . $name . $last_name . '</font><br>';
                                }
                            } elseif (is_array($retorno[$i])) {
                                $last_name = !empty($retorno[$i]['last_name']) ? ' ' . htmlentities($retorno[$i]['last_name']) : '';
                                $first_name     = !empty($retorno[$i]['first_name']) ? $retorno[$i]['first_name'] : '';
                                $name           = !empty($retorno[$i]['name']) ? $retorno[$i]['name'] : '';
                                $name           = !empty($name) ? $name : $first_name;
                                ...
                                $combo .= '<font style="color:#4e73df;"></font><br>';
                            }
                        }
                        $combo .= "";
                        $this->_result = $combo;
                ...
                case 'selectparent':
                    ...
                    if (is_array($retorno)) {
                        ...
                        for ($i = 0; $i < $lengDatos; $i++) //loop de los campos
                        {
                            ...
                            if ($retorno[$i]->$key_foraneo == $value) {
                                $combo .= '<font style="color:#4e73df;">' . $name . $last_name . '</font><br>';
                            }
                        }
                        $combo .= "";
                        $this->_result = $combo;
                ...
                case 'selectOnChange':
                    ...
                    if (is_array($retorno)) {
                        ...
                        for ($i = 0; $i < $lengDatos; $i++) //loop de los campos
                        {
                            ...
                            $last_name = !empty($retorno[$i]->last_name) ? ' ' . htmlentities($retorno[$i]->last_name) : '';
                            if ($retorno[$i]->$key_foraneo == $value) {
                                $combo .= '<font style="color:#4e73df;">' . $retorno[$i]->name . $last_name . '</font><br>';
                            }
                        }
                        $combo .= "";
                        $this->_result = $combo;
                ...
                case 'multicheckbox':
                    ...
                    if (is_array($retorno)) {
                        ...
                        for ($i = 0; $i < $lengDatos; $i++) //loop de los campos
                        {
                            ...
                            $combo .= '<input type="checkbox" name="' . $this->_typeArray['NAME'] . '[]" value="' . $retorno[$i]->id . '" ' . $is_cheked . ' class="multicheckbox"  /> ';
                            $last_name = !empty($retorno[$i]->last_name) ? ' ' . htmlentities($retorno[$i]->last_name) : '';
                            $minutes = !empty($retorno[$i]->minutes) ? htmlentities($retorno[$i]->minutes) : '';
                            // $combo .= $retorno[$i]->id.' ' . htmlentities($retorno[$i]->name) . $last_name . $minutes .'<br>';
                            if (!empty($minutes)) {
                                $a_minutes = ' <font style="color:#4e73df;">(' . $minutes . ')</font>';
                            } else {
                                $a_minutes = '';
                            }
                            $combo .= '<font style="color:#4e73df;">' . $retorno[$i]->id . '</font> - ' . htmlentities($retorno[$i]->name) . $last_name . $a_minutes . '<br>';
                        }
                        $combo .= '';
                        $this->_result = $combo;
                    }
                ...
                case 'url':
                    ...
                    break;
                case 'seeker':
                    $combo = '<font style="color:#4e73df;">' . $value . ' - ' . $value_name . '</font><br>';
                    $this->_result = $combo;
                    break;
                case 'seekerequal':
                    $combo = '<font style="color:#4e73df;">' . $value . ' - ' . $value_name . '</font><br>';
        ...
        if (isset($this->_typeArray['TYPE']) && isset($this->_typeArray['NAME']) && isset($this->_typeArray['ID']) && isset($this->_typeArray['VALUE'])) {
            ...
            switch ($this->_typeArray['TYPE']) {
                ...
                case 'multicheckbox':
                    ...
                    //     for ($i=0; $i<$lengDatos; $i++){
                    //         $retorno[$i] = (object) $retorno[$i];
                    //         $combo .= $retorno[$i]->chequeado==1 ? htmlentities($retorno[$i]->name).' - ' : '';
                    //         // $combo .= htmlentities($retorno[$i]->name).' - ';
                    //     }
                    //     $this->_result = $combo;
                    // }
