        ...
        if (isset($this->_typeArray['TYPE']) && isset($this->_typeArray['NAME']) && isset($this->_typeArray['ID']) && isset($this->_typeArray['VALUE'])) {
            ...
            switch ($this->_typeArray['TYPE']) {
                ...
                case 'file':
                    ...
                    if (!empty($value)) {
                        if (file_exists($this->_typeArray['PATHPHYSICAL'] . 'thumb/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'small/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'big/' . $value) || file_exists($this->_typeArray['PATHPHYSICAL'] . 'media/' . $value)) {
                            ...
                            if (!empty($size[0])) {
                                ...
                                $this->_result .= strtoupper(substr(strrchr($value, '.'), 1)) . ' (' . number_format(filesize($this->_typeArray['PATHPHYSICAL'] . $in_path . $value) / 1024, 2) . ' Kb)';
                            }
                            $this->_result .= '<br />';
                    ...
                    $this->_result .= '<input type="hidden" name="' . $this->_typeArray['NAME'] . '_resize_limit" id="' . $this->_typeArray['NAME'] . '_resize_limit" value="' . $this->_typeArray['RESTRICTIONS'] . '" />';
                    break;
                case 'text':
        ...
        if (isset($this->_typeArray['TYPE']) && isset($this->_typeArray['NAME']) && isset($this->_typeArray['ID']) && isset($this->_typeArray['VALUE'])) {
            ...
            switch ($this->_typeArray['TYPE']) {
                ...
                case 'richtext':
                    ...
                    break;
                case 'richcolor':
                    $this->_result = '<span style="color:' . $value . ';">' . $value . '</span>';
                    break;
                case 'longtext':
                    $this->_result = '' . $value . '';
                    break;
