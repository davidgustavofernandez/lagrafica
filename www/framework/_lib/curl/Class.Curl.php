<?php
/**
 * UseCurl, Implementation of CURL
 * 
...
class Curl{
     ...
     * @see __construct()
     * @desc instance methods for "Useagent", "Method", "CurlAvailable".
     * @access public
     */
     ...
     * @param $method, string
     * @desc Set the method that will be implemented.
     * @access public
     */
     ...
     * @desc Indicates if CURL is configured and operable in the system.
     * @access protected
     */
    ...
    public function setParams($parametersArray=''){
        if(empty($parametersArray)){
            ...
            if($this->_curl_method=='POST'){
                $this->_curl_parameters = $parametersArray;
            }else{
     ...
     * @desc: Indicates that session_id() use to apply in a remote session.
     * @access public
     */
     ...
     * @desc Indicates if you are going to implement authentication with user and password.
     * @access public
     */
     ...
     * @desc Execute a curl transaction - this exists mainly for subclasses can add additional options and / or process the response, if they wish
     * @access protected
     */
