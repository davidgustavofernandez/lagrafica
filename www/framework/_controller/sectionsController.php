<?php
/**
 * sectionsController, Controller "base"
 * 
 * The Class sectionsController is the "base" controller responsible for processing the requests.
...
# THIS ALWAYS GOES {
    ...
    public function getModel(){
        $path = dirname(__FILE__) . '/../'.FOLDER_MODEL.'sectionsModel.php';
    ...
    public function getView(){
        $path = dirname(__FILE__) . '/../'.FOLDER_VIEW.'sectionsView.php';
