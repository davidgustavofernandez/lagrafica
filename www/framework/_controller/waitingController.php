<?php
/**
 * waitingController, Controller "base"
 * 
 * The Class waitingController is the "base" controller responsible for processing the requests.
...
# THIS ALWAYS GOES {
    ...
    public function getModel(){
        $path = dirname(__FILE__) . '/../'.FOLDER_MODEL.'waitingModel.php';
    ...
    public function getView(){
        $path = dirname(__FILE__) . '/../'.FOLDER_VIEW.'waitingView.php';
