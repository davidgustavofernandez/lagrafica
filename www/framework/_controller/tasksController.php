<?php
/**
 * tasksController, Controller "base"
 * 
 * The Class tasksController is the "base" controller responsible for processing the requests.
...
# THIS ALWAYS GOES {
    ...
    public function getModel(){
        $path = dirname(__FILE__) . '/../'.FOLDER_MODEL.'tasksModel.php';
    ...
    public function getView(){
        $path = dirname(__FILE__) . '/../'.FOLDER_VIEW.'tasksView.php';
