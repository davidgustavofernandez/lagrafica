<?php
/**
 * settingsController, Controller "base"
 * 
 * The Class settingsController is the "base" controller responsible for processing the requests.
...
# THIS ALWAYS GOES {
    ...
    public function getModel(){
        $path = dirname(__FILE__) . '/../'.FOLDER_MODEL.'settingsModel.php';
    ...
    public function getView(){
        $path = dirname(__FILE__) . '/../'.FOLDER_VIEW.'settingsView.php';
...
# } THIS ALWAYS GOES
    ...
    /**
     * reloadDatabase public function
     * @uses $this->_model->setSaveOnFile()
     * @uses $this->getView(), Method, Apply the view
    ...
    public function reloadDatabase(){
        ...
        $table_fields = $this->_estructuraBbdd[$this->_database][$this->_prefix.$this->_table]['GLOBAL_data'];
        $action = $this->_action;
        $return_state = $this->_model->reloadDatabase();
        require_once($this->getView());
    }
    /**
     * seeDataConfig public function
     * @uses $this->_model->setSaveOnFile()
     * @uses $this->getView(), Method, Apply the view
     * Note: Show the data options in config
     */
