<?php
/**
 * tasksModel, Model "base"
 *
 * The tasksModel Class is the "base" model to mediate between the controller and the view by applying the model. Interact with the Database
 ...
 */
class tasksModel extends AppAbstractConnectInstance{
    /**
