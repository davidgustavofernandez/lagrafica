<?php
/**
 * waitingModel, Model "base"
 *
 * The waitingModel Class is the "base" model to mediate between the controller and the view by applying the model. Interact with the Database
 ...
 */
class waitingModel extends AppAbstractConnectInstance{
    /**
