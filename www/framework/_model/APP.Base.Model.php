...
class AppBaseModel extends AppAbstractConnectInstance{
    ...
    */
    ...
    public function getSeeker()
	{
		...
		$cl->setFields($this->_fields);
        $cl->setKey($this->_key);
        $cl->setSearchOn($this->_search_on);
        $cl->setSearchOff($this->_search_off);
        $cl->setSearchFilters($this->_search_filters);
		$cl->setStatus($this->_status);
		$cl->setRequest($_GET);
    ...
    /**
     * getExportBatch public function
     * Note: Guarda en la carpeta 'export' los archivos correspondientes a una tabla emn la base de datos.
     */
    ...
    /**
     * getExportBatchList public function
     * Note: Return a list of files
     */
    public function getExportBatchList(){
      $directory = dirname(__FILE__) .'/../../material/'.$this->_controller.'/reports/';
    ...
    public function getExportBatchFileDelete($file){
      $file = str_replace('\\','',str_replace('/','',$file));
      $file = dirname(__FILE__) .'/../../material/'.$this->_controller.'/reports/'.$file;
    ...
    public function getExportBatchEraseAllFiles(){
      $directory = dirname(__FILE__) .'/../../material/'.$this->_controller.'/reports/';
