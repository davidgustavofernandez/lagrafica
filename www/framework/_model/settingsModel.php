<?php
/**
 * settingsModel, Model "base"
 *
 * The settingsModel Class is the "base" model to mediate between the controller and the view by applying the model. Interact with the Database
 ...
 */
class settingsModel extends AppAbstractConnectInstance{
    /**
    ...
    */
     ...
     * @uses $this->_conn, Object, Connection
     * @uses dirname(), Function
     * Note: Generates physical file of the database.
     */
    public function reloadDatabase(){
      ...
      $path = dirname(__FILE__).'/../_lib/database/structure/data.inc';
      // echo $path;
      $database_size = number_format( filesize( $path )/1024 ,2).' Kb <br>';
      $returned .= "The last modification of data.inc was: " . date(DATETIME_FORMAT, filemtime($path)) . " <br> With a weight of: " . $database_size;
      # Actualize
      $estructura_bbdd = $cl->getDatabaseDump(true,true,true);
      $database_size = number_format( filesize( $path )/1024 ,2).' Kb <br>';
      $returned .= "Current modification of data.inc: " . date(DATETIME_FORMAT, filemtime($path)) . " <br> With a weight of: " . $database_size;
