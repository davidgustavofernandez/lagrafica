...
class Rules{
    ...
    private function _setItems(){
        ...
        'tablas' => array(
                array(
                    'relacion' => 'administrator_permission',
                    'tabla_a' => $this->_prefix.'administrators_permissions',
                    'tabla_b' => $this->_prefix.'administrators_permissions_relations',
                    'tabla_c' => $this->_prefix.'administrators',
                    'id_a' => 'id_administrator_permission',
                    'id_b' => 'id_administrator_permission_relation',
                    'id_c' => 'id_administrator',
                    'id_filtro' => 'id_administrator'
                )
            )
        );
    }
