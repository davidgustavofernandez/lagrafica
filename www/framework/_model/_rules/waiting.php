...
class Rules{
    ...
    private function _setItems(){
        ...
        'tablas' => array(
                array(
                    'relacion' => 'waiting_day',
                    'tabla_a' => $this->_prefix.'waiting_days',
                    'tabla_b' => $this->_prefix.'waiting_days_relations',
                    'tabla_c' => $this->_prefix.'waiting',
                    'id_a' => 'id_waiting_day',
                    'id_b' => 'id_waiting_day_relation',
                    'id_c' => 'id_waiting',
                    'id_filtro' => 'id_waiting'
                )
            )
        );
    }
