...
class Rules{
    ...
    private function _setItems(){
        ...
        'tablas' => array(
                array(
                    'relacion' => 'form_city',
                    'tabla_a' => $this->_prefix.'cities',
                    'tabla_b' => $this->_prefix.'forms_cities_relations',
                    'tabla_c' => $this->_prefix.'forms',
                    'id_a' => 'id_city',
                    'id_b' => 'id_form_city_relation',
                    'id_c' => 'id_form',
                    'id_filtro' => 'id_form'
                ),
                array(
                    'relacion' => 'form_dealer',
                    'tabla_a' => $this->_prefix.'dealers',
                    'tabla_b' => $this->_prefix.'forms_dealers_relations',
                    'tabla_c' => $this->_prefix.'forms',
                    'id_a' => 'id_dealer',
                    'id_b' => 'id_form_dealer_relation',
                    'id_c' => 'id_form',
                    'id_filtro' => 'id_form'
                ),
                array(
                    'relacion' => 'form_model',
                    'tabla_a' => $this->_prefix.'models',
                    'tabla_b' => $this->_prefix.'forms_models_relations',
                    'tabla_c' => $this->_prefix.'forms',
                    'id_a' => 'id_model',
                    'id_b' => 'id_form_model_relation',
                    'id_c' => 'id_form',
                    'id_filtro' => 'id_form'
                ),array(
                    'relacion' => 'form_purchase',
                    'tabla_a' => $this->_prefix.'purchases',
                    'tabla_b' => $this->_prefix.'forms_purchases_relations',
                    'tabla_c' => $this->_prefix.'forms',
                    'id_a' => 'id_purchase',
                    'id_b' => 'id_form_purchase_relation',
                    'id_c' => 'id_form',
                    'id_filtro' => 'id_form'
                )
            )
