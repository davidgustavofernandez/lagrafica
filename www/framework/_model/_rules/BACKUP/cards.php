...
class Rules{
    ...
    private function _setItems(){
        ...
        'tablas' => array(
                array(
                    'relacion' => 'card_specification',
                    'tabla_a' => $this->_prefix.'cards_specifications',
                    'tabla_b' => $this->_prefix.'cards_specifications_relations',
                    'tabla_c' => $this->_prefix.'cards',
                    'id_a' => 'id_card_specification',
                    'id_b' => 'id_card_specification_relation',
                    'id_c' => 'id_card',
                    'id_filtro' => 'id_card'
                )
            )
