...
$array_leds_status = array('id_order_state');
$collector = '';
$html_main = '';
...
switch($action){
  ...
  case 'reloadDatabase':
    require_once( dirname(__FILE__) . '/_actions/custom/settings/reloadDatabase.php' );
  break;

  case 'dataSettings':
    require_once( dirname(__FILE__) . '/_actions/custom/settings/dataSettings.php' );
  break;
