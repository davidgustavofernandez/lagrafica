  ...
  <div class="col-lg-12">
    <div class="ibox">
      <div class="ibox-title">
        <h5>'.$this->_m->getMessageEntites('view_settings','settings').' <small>'.$this->_m->getMessageEntites('view_settings','reload_database').'</small></h5>
      </div>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h5 class="panel-title">'.$this->_m->getMessageEntites('view_settings','reload_database').'</h5>
              </div>
