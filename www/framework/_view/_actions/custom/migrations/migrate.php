        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-lg-12 12u" class="first">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h5 class="panel-title">IMPOERTANT!</h5>
                            </div>
                            <div class="panel-body">
                                <h5>The migration "'.$return_migrate['vars']['migrate_name'].'" to SECURE was successful!</h5>
                                <div CLASS="separador"></div>
                                <p>You can see the local log of migrations made by clicking on the following button  <a href="'.$urlMigratesLogsEntities.'" class="btn btn-primary btn-xs">'.$this->_m->getMessageEntites('view_migates','migrate_log_button').'</a></p>
                                <p>You can also access the log in the PRODUCTION environment and execute the new implementation by clicking on the following button <a href="'.$urlMigratesLogsProductionEntities.'" class="btn btn-primary btn-xs" target="_blank">'.$this->_m->getMessageEntites('view_migates','migrate_log_production').'</a></p>
                                <div CLASS="separador"></div>
                                <p>'.$return_migrate['message'].'</p>
                            </div>
                            <div class="panel-footer">
                                <a href="'.$urlListedEntities.'" class="btn btn-primary btn-xs">'.$this->_m->getMessageEntites('view_migates','content_list_button').'</a>
                            </div>
                        </div>
                    </div>
...
// '.$return_migrate['message'].'
// | '.$return_migrate['vars']['id_migration'].'
// | '.$return_migrate['vars']['migrate_name'].'
// | '.$return_migrate['vars']['api_host_url'].'
