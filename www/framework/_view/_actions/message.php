        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="12u" class="first">
                        <div class="panel panel-danger">
                            <div class="panel-heading">
                                <h5 class="panel-title">IMPOERTANT!</h5>
                            </div>
                            <div class="panel-body">
                                <h5>You cannot deactivate a section when you have secondary sections.</h5>
                                <div CLASS="separador"></div>
                                <p>If you need to disable this section, first disable the secondary sections.</p>
                            </div>
                            <div class="panel-footer">
                                <a href="'.$urlListedEntities.'" class="btn btn-primary btn-xs">'.$this->_m->getMessageEntites('view_dashboard','content_list_button').'</a>

                                <a href="'.$urlSearchParentEntities.'" class="btn btn-primary btn-xs"><i class="fa fa-list" aria-hidden="true"></i> List Childs</a>
                            </div>
                        </div>
                    </div>
