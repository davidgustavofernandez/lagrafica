                    ...
                    <div class="12u" class="first">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <h5>la importación ha sido un éxito.</h5>
                                <div CLASS="separador"></div>
                                <p>se importaron <strong>'.$success['total'].'</strong> nuevos registros en la entidad <strong>'.$success['controller'].'</strong></p>
                            </div>
                            <div class="panel-footer">
                                <a href="'.$urlListedEntities.'" class="btn btn-primary btn-xs">'.$this->_m->getMessageEntites('view_dashboard','content_list_button').'</a>
                                <a href="'.$urlListedSuccess.'" class="btn btn-primary btn-xs"><i class="fa fa-list" aria-hidden="true"></i> Listed '.$success['controller'].'</a>
                            </div>
                        </div>
                    </div>
